...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/setting/permission/{id}/edit', 'PermissionController@edit')->name('setting.permission.update');
    Route::post('/setting/permission/{id}/update', 'PermissionController@update')->name('setting.permission.update');
    ...
    Route::get('/setting/role/{id}/edit', 'RoleController@edit')->name('setting.role.update');
    Route::post('/setting/role/{id}/update', 'RoleController@update')->name('setting.role.update');
    ...
    Route::get('/setting/user/{id}/edit', 'UserController@edit')->name('setting.user.update');
    Route::post('/setting/user/{id}/update', 'UserController@update')->name('setting.user.update');

...
$.extend( true, DataTable.defaults, {
	dom:"<'row uk-grid'<'uk-width-1-2'<'uk-inline l'l><'uk-inline B'B>><'uk-width-1-2'f>>" +
...
DataTable.ext.renderer.pageButton.uikit = function ( settings, host, idx, buttons, page, pages ) {
	...
	attach(
		$(host).empty().html('<ul class="uk-pagination twb-pagination uk-flex-right"/>').children('ul'),
		buttons
	);

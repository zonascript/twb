...
@section('content')
    ...
    <form class="uk-form" action="{!! action('PromoController@update', $post->id) !!}" method="POST">
        {!! csrf_field() !!}
            ...
            <div class="uk-width-1-3">
                <div class="uk-card uk-card-small uk-margin k-border white">
                    ...
                    <div class="uk-card-footer uk-flex uk-flex-middle uk-flex-between">
                        <a href="{!! action('PromoController@index') !!}" class="uk-button uk-button-default">Back</a>

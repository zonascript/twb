...
@section('content')
    ...
    <h3>
        ...
        @if(userCan('promo.add'))
        <a href="{!! action('PromoController@create') !!}" class="uk-button uk-button-primary uk-button-small uk-margin-left">Add New</a>
        @endif
    </h3>
...
<script type="text/javascript">
    $(function() {
        $('#thetable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! action('PromoController@datatableList') !!}',
            columns: [

...
@section('content')
    ...
    <form class="uk-form" action="{!! action('EventController@store') !!}" method="POST">
        {!! csrf_field() !!}
            ...
            <div class="uk-width-1-3">
                <div class="uk-card uk-card-small uk-margin k-border white">
                    <div class="uk-card-body">
                        ...
                        <input type="text" class="uk-input" name="event_date" data-uk-datepicker="{format:'DD/MM/YYYY',minDate:1}">
                        <hr class="uk-hr">

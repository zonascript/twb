<div id="upload-modal" class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <form class="uk-grid-collapse uk-grid-match" method="post" action="{!! route('ajaxImageUpload') !!}" uk-grid enctype="multipart/form-data" id="upload-form">
            {!! csrf_field() !!}
            <div id="upload-errors" class="uk-width-1-1"></div>
